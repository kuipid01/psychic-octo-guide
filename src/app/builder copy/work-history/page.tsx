  ...
  return (
    <div className=" h-fit py-[40px] flex md:flex-row bg-gray-300 flex-col justify-center items-center ">
      <div className=" p-[20px] h-screen  rounded-md flex flex-col bg-white size-[90%] ">
        <div className=" flex w-full items-center flex-1 gap-10 justify-evenly">
          ...
          <div className=" w-[20%] h-[50vh] flex p-5 justify-center gap-3 items-center flex-col text-center rounded-xl bg-gray-300">
